...
function Hero() {
  ...
  return (
    <div className="relative w-full min-h-[80vh] flex items-center justify-center bg-background-dark">
        ...
        <div className="flex flex-col items-center justify-center gap-8 py-16">
          <Link to="/les-mer">
            <Button 
              variant="secondary" 
              size="sm" 
              className="gap-2 bg-white/5 hover:bg-white/10 backdrop-blur-sm text-white/80 hover:text-white font-medium rounded-full border border-white/10"
            >
            ...
            {!user ? (
              <>
                ...
                <Link to="/register">
                  <Button 
                    size="lg" 
                    className="gap-2 bg-primary hover:bg-primary/90 text-white font-medium rounded-full"
                  >
