...
const YieldCards = ({ yields }: YieldCardsProps) => {
  return (
    <div className="flex overflow-x-auto gap-2 pb-2 -mx-1 px-1">
      <div className="min-w-[130px] max-w-[130px] bg-nordic-softblue p-2 rounded-lg flex flex-col items-center justify-between border border-blue-100 shadow-sm">
        <div className="flex items-center gap-1 mb-1">
          <Clock className="w-4 h-4 text-nordic-blue" />
          <p className="text-xs text-gray-600">Daglig</p>
        </div>
        <p className="text-base font-bold text-nordic-blue">
