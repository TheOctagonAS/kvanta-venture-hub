        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-[#222] tracking-wide">Eiendom</h3>
            </div>
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                <span className="w-3 h-3 bg-blue-600 rounded-full flex-shrink-0"></span>
                <span className="text-[#555]">Stabil verdiutvikling over tid</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="w-3 h-3 bg-blue-600 rounded-full flex-shrink-0"></span>
                <span className="text-[#555]">Fysisk sikkerhet i eiendommen</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="w-3 h-3 bg-blue-600 rounded-full flex-shrink-0"></span>
                <span className="text-[#555]">Jevne leieinntekter</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-semibold text-[#222] tracking-wide">Tradisjonelle Aksjer</h3>
            </div>
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                <span className="w-3 h-3 bg-gray-400 rounded-full flex-shrink-0"></span>
                <span className="text-[#555]">Høyere volatilitet</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="w-3 h-3 bg-gray-400 rounded-full flex-shrink-0"></span>
                <span className="text-[#555]">Usikker utbyttebetaling</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="w-3 h-3 bg-gray-400 rounded-full flex-shrink-0"></span>
                <span className="text-[#555]">Mer påvirket av markedssvingninger</span>
              </li>
            </ul>
          </div>
        </div>
